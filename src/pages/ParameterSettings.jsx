        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-neutral-50 p-4 rounded-lg">
            <div className="text-sm text-neutral-600 mb-3">
              ...
              <p>Working day runs from <span className="font-medium">{localParams.workingHours.start}</span> to <span className="font-medium">{localParams.workingHours.end}</span></p>
              <p>Total required hours: <span className="font-medium">{localParams.workingHours.totalRequired} hours</span></p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <TimeSlider
              ...
              step={15}
              markers={[
                { time: localParams.lunchBreak.defaultStart, label: 'Default lunch start' }
              ]}
            />
          </div>
          ...
          <div className="bg-neutral-50 p-4 rounded-lg">
            <div className="text-sm text-neutral-600">
              ...
              <p>Duration: <span className="font-medium">{localParams.lunchBreak.duration} minutes</span></p>
              <p>Default start time: <span className="font-medium">{localParams.lunchBreak.defaultStart}</span></p>
              <p>Flexible window: <span className="font-medium">{localParams.lunchBreak.flexWindowStart} - {localParams.lunchBreak.flexWindowEnd}</span></p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-neutral-50 p-4 rounded-lg">
            <div className="text-sm text-neutral-600">
              ...
              {localParams.breaks.morning.enabled ? (
                <p>Morning break: <span className="font-medium">{localParams.breaks.morning.duration} minutes</span> at <span className="font-medium">{localParams.breaks.morning.defaultTime}</span></p>
              ) : (
                <p>Morning break: <span className="text-neutral-400">Disabled</span></p>
              )}
              
              {localParams.breaks.afternoon.enabled ? (
                <p>Afternoon break: <span className="font-medium">{localParams.breaks.afternoon.duration} minutes</span> at <span className="font-medium">{localParams.breaks.afternoon.defaultTime}</span></p>
              ) : (
                <p>Afternoon break: <span className="text-neutral-400">Disabled</span></p>
              )}
              
              <p className="mt-2">
                Total daily break time: <span className="font-medium">
                  {(localParams.breaks.morning.enabled ? localParams.breaks.morning.duration : 0) + 
                   (localParams.breaks.afternoon.enabled ? localParams.breaks.afternoon.duration : 0)} minutes
                </span>
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start">
            ...
            <div className="text-sm text-primary-800">
              ...
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>
                  <strong>Overtime:</strong> Time beyond {localParams.lateStay.maxMinutes} minutes after shift end is paid at {localParams.lateStay.overtimeMultiplier}× rate.
                </li>
              </ul>
            </div>
          </div>
