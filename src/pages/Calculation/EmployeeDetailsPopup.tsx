...
const EmployeeDetailsModal: React.FC<IProps> = ({ onClose, isOpen, userCalculation: user }) => {
    ...
    return (
        <Modal size='7xl' isOpen={isOpen} onClose={onClose} title={'Record Details'}>
            <div className='space-y-6 py-4'>
                                            ...
                                            {parameters.shiftBonus?.isShiftBonus && (
                                                <div className='flex justify-between font-semibold'>
                                                    ...
                                                    <span className='flex gap-1 items-center'>
                                                        <GiMoneyStack className='text-green-600' size={20} />{' '}
                                                        {parameters.shiftBonus?.bonusAmount || 0}
                                                    </span>
                                                </div>
                                            )}
                                    ...
                                    <div className='p-3 bg-neutral-50 rounded-lg'>
                                        ...
                                        <div className='text-sm space-y-2'>
                                            ...
                                            <div className='mt-2 pt-2 border-t border-neutral-200 flex justify-between font-semibold'>
                                                ...
                                                <span>
                                                    {formatBreakTime(calculationResult.lunchDuration + calculationResult.otherBreaksDuration)}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
