  ...
  return (
    <div className="space-y-6 py-4">
      <TitleText
        ...
        subtitle="Simulate working time calculations based on your settings"
      />
              ...
              <div>
                ...
                <div className="bg-neutral-50 p-4 rounded-lg text-sm space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {parameters.workingHours.totalRequired} hours
                    </span>
                  </div>
              ...
              <div className="space-y-4">
                <div className="p-3 bg-primary-50 rounded-lg">
                  ...
                  <div className="text-sm space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {calculationResult.overtimeHours}
                      </span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="p-3 bg-neutral-50 rounded-lg">
                  ...
                  <div className="text-sm space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {formatBreakTime(calculationResult.otherBreaksDuration)}
                      </span>
                    </div>
                  ...
                  <div className="text-sm space-y-1.5">
                    ...
                    {calculationResult.earlyDeparture && (
                      <div className="text-warning-600">
                        <FaExclamationCircle className="inline-block mr-1" />
                        Left early by {
                          calculationResult.earlyDepartureMinutes
                        }{" "}
                        min
                      </div>
                    )}
                    ...
                    {calculationResult.lateDeparture && (
                      <div className="text-primary-600">
                        <FaExclamationCircle className="inline-block mr-1" />
                        Stayed late by {
                          calculationResult.lateDepartureMinutes
                        }{" "}
                        min
                ...
                <div className="mt-4">
                  ...
                  <div className="flex text-xs justify-between">
                    <span>0</span>
                    <span className="font-medium">
                      {parameters.workingHours.totalRequired} hours (required)
                    </span>
                  </div>
