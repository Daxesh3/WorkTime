...
const AddEditCompanyModal: React.FC<AddEditCompanyModalProps> = ({ isOpen, onClose, onSave, initialData }) => {
    ...
    const handleParameterChange = (field: string, value: any, section?: keyof ShiftTiming) => {
        if (!section) {
            setParameters((prev) => ({
                ...prev,
                [field]: value,
                        ...
                        <Card title='Working Hours' icon={<FiClock size={20} />}>
                            <div className='grid grid-cols-2 gap-4'>
                                ...
                                <div>
                                    ...
                                    <TimePicker value={parameters.end} onChange={(value) => handleParameterChange('end', value)} className='w-full' />
                                </div>
                                {/* <div>
                            ...
                            <div className='grid grid-cols-2 gap-4'>
                                <div>
                                    ...
                                    <TimePicker
                                        ...
                                        onChange={(value) => handleParameterChange('defaultStart', value, 'lunchBreak')}
                                        className='w-full'
                                    />
                                </div>
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => handleParameterChange('duration', parseInt(e.target.value, 10), 'lunchBreak')}
                                        className='time-input w-full'
                                        min='0'
                                    />
                                </div>
                                <div>
                                    ...
                                    <TimePicker
                                        ...
                                        onChange={(value) => handleParameterChange('flexWindowStart', value, 'lunchBreak')}
                                        className='w-full'
                                    />
                                </div>
                                <div>
                                    ...
                                    <TimePicker
                                        ...
                                        onChange={(value) => handleParameterChange('flexWindowEnd', value, 'lunchBreak')}
                                        className='w-full'
                                    />
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div className='mb-4'>
                                        ...
                                        <div className='flex items-center'>
                                            <input
                                                ...
                                                onChange={(e) => handleParameterChange('maxMinutes', parseInt(e.target.value), 'earlyArrival')}
                                    ...
                                    <div className='flex items-center mb-4'>
                                        <input
                                            ...
                                            onChange={(e) => handleParameterChange('countTowardsTotal', e.target.checked, 'earlyArrival')}
                                ...
                                <div>
                                    ...
                                    <div className='mb-4'>
                                        ...
                                        <div className='flex items-center'>
                                            <input
                                                ...
                                                onChange={(e) => handleParameterChange('maxMinutes', parseInt(e.target.value), 'lateStay')}
                                                className='time-input w-24'
                                            />
                                            <span className='ml-2 text-neutral-600'>minutes</span>
                                        </div>
                                    ...
                                    <div className='flex items-center mb-4'>
                                        <input
                                            ...
                                            onChange={(e) => handleParameterChange('countTowardsTotal', e.target.checked, 'lateStay')}
                                            className='h-4 w-4 text-primary-600 focus:ring-primary-500 border-neutral-300 rounded'
                                        />
                                    ...
                                    <div className='mb-4'>
                                        ...
                                        <div className='flex items-center'>
                                            <input
                                                ...
                                                onChange={(e) => handleParameterChange('overtimeMultiplier', parseFloat(e.target.value), 'lateStay')}
                                                className='time-input w-24'
                                            />
                                ...
                                <div className='flex items-start'>
                                    ...
                                    <div className='text-sm text-primary-800'>
                                        ...
                                        <ul className='list-disc list-inside space-y-1'>
                                            <li>
                                                <strong>Early arrival:</strong> Employees arriving up to {parameters.earlyArrival.maxMinutes} minutes
                                                early
                                            ...
                                            <li>
                                                <strong>Overtime:</strong> Time beyond {parameters.lateStay.maxMinutes} minutes after shift end is
                                                paid at {parameters.lateStay.overtimeMultiplier}× rate.
                                            </li>
                                        </ul>
                                    </div>
                                </div>
